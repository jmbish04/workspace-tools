 ...
 * It uses the new ChatProvider interface via adapters to maintain compatibility with the existing agents system
 * while benefiting from the improved provider implementations.
 */
